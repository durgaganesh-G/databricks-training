...
INSTRUCTIONS:
1. This file contains SQL queries corresponding to questions 31 through 65.
2. Queries are compatible with MySQL/PostgreSQL environments.
3. For Query 51 (Nth salary), change the OFFSET value as needed (OFFSET 2 is for 3rd highest).
========================================================================
